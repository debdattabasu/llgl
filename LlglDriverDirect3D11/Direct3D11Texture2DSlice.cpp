...
void Direct3D11Texture2DSlice::initializeDriver()
{
...
void Direct3D11Texture2DSlice::copyFromDriver(Texture2DSlicePtr src, uint32_t srcOffsetX, uint32_t srcOffsetY,
