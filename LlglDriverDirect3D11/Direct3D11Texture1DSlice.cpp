...
void Direct3D11Texture1DSlice::initializeImpl()
{
...
void Direct3D11Texture1DSlice::copyFromImpl(Texture1DSlicePtr src, uint32_t srcOffset, uint32_t srcWidth, uint32_t destOffset) 
{
