...
public:
	...
	void readFromDriver(Texture3DSlicePtr src, uint32_t offsetX, uint32_t offsetY, uint32_t offsetZ) override;
	void writeToDriver(Texture3DSlicePtr dest, uint32_t offsetX, uint32_t offsetY, uint32_t offsetZ) override;
